					...
					<div class="ui-form-item ui-form-item-time">
						...
						<select name="ttype" class="BigStatic">
						 <option value="" selected="selected"></option>
						  <option value="company" <?php if ($ttype=='company'){?>selected="selected"<?php }?>>单位名称</option>
...
<a href="admin.php?ac=user&fileurl=communication" class="ui-tab-trigger-text">单位通迅录</a></li>					
</ul>
				</div>
