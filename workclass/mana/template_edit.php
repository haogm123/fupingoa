...
<table width="90%" border="0" align="center" cellpadding="3" cellspacing="0" class="small">
  <tr>
    <td class="Big"><img src="template/default/content/images/notify_new.gif" align="absmiddle"><span class="big3"> 工作流模型编辑</span>&nbsp;&nbsp;&nbsp;&nbsp;
...
<table class="TableBlock" border="0" width="90%" align="center">
	...
	<tr>
      ...
      <select name="typeid">
			...
			<?php echo work_type_options($blog['typeid'])?>
			</select> </td>
    </tr>
	<tr>
	...
	<tr>
      ...
      <td class="TableData">
      <?php
	  get_pubuser(2,"tpluser",$blog['tpluser'],"+选择使用人员",50,4)
	...
	<tr>
      ...
      <td class="TableData">
      <?php
	  get_pubuser(2,"tpladmin",$blog['tpladmin'],"+选择管理人员",50,4)
