...
<table width="70%" border="0" align="center" cellpadding="3" cellspacing="0" class="small">
  <tr>
    <td class="Big"><img src="template/default/content/images/notify_new.gif" align="absmiddle"><span class="big3"> 工作流表单编辑</span>&nbsp;&nbsp;&nbsp;&nbsp;
...
#div2{display:block;}
	...
	<form name="save" method="post" action="admin.php?ac=<?php echo $ac?>&fileurl=<?php echo $fileurl?>&tplid=<?php echo $tplid?>&flowid=<?php echo $flowid?>&typeid=<?php echo $typeid?>&formtype=<?php echo $formtype?>&do=add&fromid=<?php echo $fromid?>">
	<input type="hidden" name="view" value="edit" />
	
<table class="TableBlock" border="0" width="70%" align="center">
   
	<tr>
      <td nowrap class="TableContent" width="120"> 表单名称：<? get_helps()?></td>
      <td class="TableData">
      <input type="text" name="fromname" class="BigInput" style="width:268px;" size="20" value="<?php echo $blog['fromname']?>" /></td>
    </tr>
	<!--<tr>
      <td nowrap class="TableContent" width="120"> 控件名称：<? get_helps()?></td>
      <td class="TableData">
      <input type="text" name="inputname" class="BigInput" style="width:268px;" size="20" value="<?php echo $blog['inputname']?>" /></td>
    </tr> -->
	<tr>
      <td nowrap class="TableContent" width="120"> 默认值：</td>
      <td class="TableData">
      <input type="text" name="inputvalue" class="BigInput" style="width:268px;" size="20" value="<?php echo $blog['inputvalue']?>" />
	  </td>
    </tr>
	<tr>
      <td nowrap class="TableContent" width="120"> 类型：</td>
      <td class="TableData">
...
<div  id="div2">
 <table class="TableBlock" border="0" width="70%" align="center" style="border-top:0px;" >
	...
	<tr>
      <td nowrap class="TableContent" width="120"> 表单类型：</td>
      <td class="TableData">
...
<div id="div1">
 <table class="TableBlock" border="0" width="70%" style="border-top:0px;" align="center">
      <td nowrap class="TableContent" width="120"> 表单参数：<? get_helps()?></td>
      <td class="TableData">
 ...
 <table class="TableBlock" border="0" width="70%" style="border-top:0px;" align="center">
	...
	<tr>
      <td nowrap class="TableContent" width="120"> 验证方式：</td>
      <td class="TableData">
