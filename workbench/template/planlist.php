...
<div id="content" class="ui-content fn-clear" coor="default" coor-rate="0.02">
	<div class="ui-grid-21" coor="content">
		<div class="ui-grid-21 ui-grid-right record-tit" coor="title">
			<h2 class="ui-tit-page">计划信息列表</h2>
			
			<div class="record-tit-amount">
				<p>总共有<span class="number"><?php echo public_number('plan')?></span>条数据
              </p>
			</div>
		</div>
				...
				<div class="record-search-time fn-clear">
					<div class="ui-form-item ui-form-item-time">
						...
						<div id="J-set-date" class="quick-link-date  blue-links  ">
							...
							<a href="admin.php?ac=<?php echo $ac?>&fileurl=<?php echo $fileurl?>&ischeck=3" seed="CR-today" id="J-today" >今天</a>
							<a href="admin.php?ac=<?php echo $ac?>&fileurl=<?php echo $fileurl?>&ischeck=4" seed="CR-sevenday" id="J-seven-day">3天内</a>
							<a href="admin.php?ac=<?php echo $ac?>&fileurl=<?php echo $fileurl?>&ischeck=5" seed="CR-month" id="J-a-month" >1周内</a>
							<a href="admin.php?ac=<?php echo $ac?>&fileurl=<?php echo $fileurl?>&ischeck=6" seed="CR-month" id="J-a-month" >1个月内</a>
							<a href="admin.php?ac=<?php echo $ac?>&fileurl=<?php echo $fileurl?>&ischeck=7" seed="CR-month" id="J-a-month" >6个月内</a>
						</div>
					</div>
			  </div>
			</div>
...
<a href="admin.php?ac=<?php echo $ac?>&fileurl=<?php echo $fileurl?>" class="ui-tab-trigger-text">我发布的计划</a></li>
<li class="ui-tab-trigger-item<?php echo $_check['ischeck1']?>">
<a href="admin.php?ac=<?php echo $ac?>&fileurl=<?php echo $fileurl?>&ischeck=1" class="ui-tab-trigger-text">我参与的计划</a></li>
<li class="ui-tab-trigger-item<?php echo $_check['ischeck2']?>">
<a href="admin.php?ac=<?php echo $ac?>&fileurl=<?php echo $fileurl?>&ischeck=2" class="ui-tab-trigger-text">我负责的计划</a></li>
<li class="ui-tab-trigger-item<?php echo $_check['ischeck8']?>">
<a href="admin.php?ac=<?php echo $ac?>&fileurl=<?php echo $fileurl?>&ischeck=8" class="ui-tab-trigger-text">己完成的计划</a></li>					
</ul>
				</div>
...
<div class="fn-right">
<?php echo get_exceldown('excel_6')?></div>
</div>
...
<td class="info"><?php
						...
						?></td>
<td class="info"><?php echo $row['type']?></td>
<td class="info"><?php
						if($row['completiondate']!=''){
						echo "已完成";
						}else{
