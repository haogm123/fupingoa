...
<div id="content" class="ui-content fn-clear" coor="default" coor-rate="0.02">
	<div class="ui-grid-21" coor="content">
		<div class="ui-grid-21 ui-grid-right record-tit" coor="title">
			<h2 class="ui-tit-page">办公用品列表</h2>
...
<a href="admin.php?ac=<?php echo $ac?>&fileurl=<?php echo $fileurl?>" class="ui-tab-trigger-text">办公用品列表</a></li>					
</ul>
				</div>
...
<div class="fn-right">
<?php echo get_exceldown('excel_21')?></div>
</div>
...
<td width="60">
<?php get_urlkey("编辑","admin.php?ac=edit&do=list&fileurl=goods&id=".$row['id']."","".$row['uid']!=$_USER->id)?>
</td>						
</tr>
<?}?>			
