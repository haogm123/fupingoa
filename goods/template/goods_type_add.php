...
<table width="90%" border="0" align="center" cellpadding="3" cellspacing="0" class="small">
  <tr>
    <td class="Big"><img src="template/default/content/images/notify_new.gif" align="absmiddle"><span class="big3"> 办公用品类别发布</span>&nbsp;&nbsp;&nbsp;&nbsp;
...
<form name="save" method="post" action="?ac=goods_type_add&do=save&fileurl=goods">
