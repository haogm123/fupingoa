...
<table width="90%" border="0" align="center" cellpadding="3" cellspacing="0" class="small">
  <tr>
    <td class="Big"><img src="template/default/content/images/notify_new.gif" align="absmiddle"><span class="big3"> 新增办公用品采购</span>&nbsp;&nbsp;&nbsp;&nbsp;
...
<form name="save" method="post" action="?ac=goods_purchase_add&do=save&fileurl=goods">
	<input type="hidden" name="savetype" value="add" />
<table class="TableBlock" border="0" width="90%" align="center" style="border-bottom:#4686c6 solid 0px;">
    <tr>
      <td nowrap class="TableContent">单号:<? get_helps()?></td>
      <td class="TableData"><input name="number" type="text" class="BigInput" id="number" style="width: 300px;" value="<?php echo get_date('YmdHis',PHP_TIME)?>" maxlength="100" />  </td>
    </tr>
    <tr>
      <td nowrap class="TableContent" width="15%"> 申请人：<? get_helps()?></td>
      <td class="TableData">			
	 <?php
	  get_pubuser(1,"application",get_realname($_USER->id),"+选择申请人",60,20)
	  ?>
    ...
    <tr>
      ...
      <td class="TableData">
<input name="startdate" type="text" class="BigInput" id="startdate" style="width: 120px;" value="<?php echo get_date('Y-m-d',PHP_TIME)?>" maxlength="100" onClick="WdatePicker();" />      </td>
    </tr>
	<tr>
	...
	<tr>
	  ...
	  <table width="95%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
		  ...
		  <td height="20"><input name="goods_goodsnumber[]" type="text" class="BigInput" style="width: 40px;" value="1" onKeyUp="value=value.replace(/[^0-9]/g,'');" /></td>
