...
<table width="90%" border="0" align="center" cellpadding="3" cellspacing="0" class="small">
  <tr>
    <td class="Big"><img src="template/default/content/images/notify_new.gif" align="absmiddle"><span class="big3"> 办公用品编辑</span>&nbsp;&nbsp;&nbsp;&nbsp;
...
<table class="TableBlock" border="0" width="90%" align="center" style="border-bottom:#4686c6 solid 0px;">
    <tr>
      ...
      <td class="TableData">
		...
		<?php GET_FILE_PUBLIC_LIST(0,$blog['goods_type'])?>
		</select>	</td>
    </tr>
    <tr>
      <td nowrap class="TableContent"> 编号：<? get_helps()?></td>
      <td class="TableData">
<input name="number" type="text" class="BigInput" id="number" style="width: 300px;" value="<?php echo $blog['number']?>" maxlength="100" />      </td>
    </tr>
	<tr>
      <td nowrap class="TableContent"> 名称：<? get_helps()?></td>
      <td class="TableData">
<input name="title" type="text" class="BigInput" id="title" style="width: 300px;" value="<?php echo $blog['title']?>" maxlength="100" />      </td>
    </tr>
	<tr>
      <td nowrap class="TableContent"> 规格：</td>
      <td class="TableData">
<input name="specification" type="text" class="BigInput" value="<?php echo $blog['specification']?>" id="specification" style="width: 300px;" maxlength="100" /></td>
    </tr>
	<tr>
      <td nowrap class="TableContent"> 单位：<? get_helps()?></td>
      <td class="TableData">
<input name="unit" type="text" class="BigInput" id="unit" value="<?php echo $blog['unit']?>" style="width: 300px;"  maxlength="100" />      </td>
    </tr>
	<tr>
      <td nowrap class="TableContent"> 单价：<? get_helps()?></td>
      <td class="TableData">
<input name="price" type="text" class="BigInput" id="price" value="<?php echo $blog['price']?>" size="40" style="width: 100px;" onKeyUp="value=value.replace(/[^0-9^.]/g,'');" />/元  非中文，如填写格式"2.68"  </td>
    </tr>
<!--	<tr>
...
<a href="#" onClick="window.open ('admin.php?ac=oamember&fileurl=approval&inputname=purchase', 'newwindow', 'height=500, width=550, top=0, left=0, toolbar=no, menubar=no, scrollbars=yes, resizable=no,location=no, status=no')" >
			选择采购人员
			</a><input type="text" name="purchase" value="<?php echo $blog['purchase']?>" style="border:0px; background-color:#FFFFFF; width:400px;"><br> 指该物品的采购负责人员，具有审批采购单申请权限! </td>
    </tr> -->
	<!--<tr>
...
<a href="#" onClick="window.open ('admin.php?ac=oamember&fileurl=approval&inputname=examination', 'newwindow', 'height=500, width=550, top=0, left=0, toolbar=no, menubar=no, scrollbars=yes, resizable=no,location=no, status=no')" >
			选择审批人员
			</a><input type="text" name="examination" value="<?php echo $blog['examination']?>" style="border:0px; background-color:#FFFFFF; width:400px;"><br> 指该物品的管理人员，具有审批、管理该物品的权限</td>
    </tr> -->
	<!--<tr>
...
<a href="#" onClick="window.open ('admin.php?ac=oamember&fileurl=approval&inputname=warehousing', 'newwindow', 'height=500, width=550, top=0, left=0, toolbar=no, menubar=no, scrollbars=yes, resizable=no,location=no, status=no')" >
			选择库存人员
			</a><input type="text" name="warehousing" value="<?php echo $blog['warehousing']?>" style="border:0px; background-color:#FFFFFF; width:400px;"><br> 指该物品的库存管理员，具有入库、盘点的权限</td>
    </tr> -->
