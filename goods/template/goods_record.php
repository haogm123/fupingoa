	...
	<div class="ui-grid-21" coor="content">
		<div class="ui-grid-21 ui-grid-right record-tit" coor="title">
			...
			<div class="record-tit-amount">
				<p>总共有<span class="number"><?php echo public_number('office_goods')?></span>条数据
              </p>
			</div>
		</div>
		...
		<div class="ui-grid-21 ui-grid-right fn-clear" coor="total">
		                                <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                          <tr>
                                            ...
                                            <td width="9%" align="right" style="padding-right:10px;"><input type="button" value="发布信息" class="BigButtonBHover" onClick="javascript:window.location='admin.php?ac=add&fileurl=goods'"></td>
                                          </tr>
                                        </table>
...
<a href="admin.php?ac=<?php echo $ac?>&fileurl=<?php echo $fileurl?>" class="ui-tab-trigger-text">办公用品领用</a></li>	
...
<li class="ui-tab-trigger-item">
<a href="admin.php?ac=goods_record_view&fileurl=goods&mykey=1" class="ui-tab-trigger-text">我的领用记录</a></li>					
</ul>
				</div>
...
<span style="font-size:16px; color:#006600;font-weight:900;"><?php echo $num_read?></span><?php echo $row['unit']?></td>
<td class="info"><?php echo $row['date']?></td>
<td width="80"><?php echo get_realname($row['uid'])?></td>
<td width="60">
<? if($num_read!=0){?>
<a href="admin.php?ac=goods_record_add&do=list&fileurl=goods&id=<?php echo $row['id']?>">+ 领用</a>
<? }?>
</td>						
</tr>
<?}?>			
