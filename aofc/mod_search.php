			...
			<div id="J-advanced-filter-option" class="">
				<div class="record-search-time fn-clear">
					<div class="ui-form-item ui-form-item-time">
						<label class="ui-form-label" for="J-start">所属处室：</label>
						<div class="ui-form-content">
							<input type="text" value="<?php echo $_POST['sscs']?>" name="sscs" class="ui-input search-keyword" id="J-keyword" style="width:160px;">

						</div>
						<label class="ui-form-label" for="J-start">文件类别：</label>
						<div class="ui-form-content">
							<input type="text" value="<?php echo $_POST['ftype']?>" name="ftype" class="ui-input search-keyword" id="J-keyword" style="width:160px;">
						</div>
						<label class="ui-form-label" for="J-start">缮印人：</label>
						<div class="ui-form-content">
							<input type="text" value="<?php echo $_POST['repairs']?>" name="repairs" class="ui-input search-keyword" id="J-keyword" style="width:100px;">
						</div>
						
						<label class="ui-form-label" for="J-start">缮印时间：</label>
						<div class="ui-form-content">
						<input type="text" value="<?php echo $_POST['rtime1']?>"  class="ui-input i-date" readonly="readonly"  onClick="WdatePicker();" name='rtime1' > - <input type="text" value="<?php echo $_POST['rtime2']?>"  class="ui-input i-date" readonly="readonly"  onClick="WdatePicker();" name='rtime2' >
						</div>
