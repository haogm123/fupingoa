...
<table width="90%" border="0" align="center" cellpadding="3" cellspacing="0" class="small">
  <tr>
    <td class="Big"><img src="template/default/content/images/notify_new.gif" align="absmiddle"><span class="big3"> 新增固定资产</span>&nbsp;&nbsp;&nbsp;&nbsp;
...
<table class="TableBlock" border="0" width="90%" align="center">
    ...
    <tr>
      ...
      <td class="TableData">
		...
		<?php get_property_type()?>
		</select>		还没有分类? <a href="admin.php?ac=property_type&fileurl=property">点击添加分类>> </a></td>
    </tr>
    <tr>
      <td nowrap class="TableContent"> 资产编号：</td>
      <td class="TableData">
<input name="number" type="text" class="BigInput" id="number" style="width: 200px;" value="<?php echo get_date('YmdHis',PHP_TIME)?>" maxlength="100" />      </td>
    </tr>
	<tr>
      <td nowrap class="TableContent"> 资产名称：<? get_helps()?></td>
      <td class="TableData">
<input name="name" type="text" class="BigInput" id="name" style="width: 300px;" maxlength="100" />      </td>
    </tr>
	<tr>
...
<select class="BigStatic" name="department">
	...
	<tr>
      ...
      <td class="TableData">
<input name="cptl_val" type="text" class="BigInput" id="cptl_val" onKeyUp="value=value.replace(/[^0-9^.]/g,'');" onkeypress="check_input()" onblur="check_value(this)" style="width: 120px;"  maxlength="100" />&nbsp;只能填写数字      </td>
    </tr>
	<tr>
      <td nowrap class="TableContent"> 残值：<? get_helps()?></td>
      <td class="TableData">
<input name="cptl_bal" type="text" class="BigInput" id="cptl_bal" onKeyUp="value=value.replace(/[^0-9^.]/g,'');" onkeypress="check_input()" onblur="check_value(this)" size="40" style="width: 120px;" />&nbsp;只能填写数字     </td>
    </tr>
	<tr>
      <td nowrap class="TableContent"> 折旧年限：<? get_helps()?></td>
      <td class="TableData">
<input name="dpct_yy" type="text" class="BigInput" id="dpct_yy" style="width: 120px;" onKeyUp="value=value.replace(/[^0-9^.]/g,'');" onkeypress="check_input()" onblur="check_value(this)" value="" size="40" />&nbsp;只能填写数字 </td>
    </tr>
	<tr>
      <td nowrap class="TableContent"> 累计折旧：<? get_helps()?></td>
      <td class="TableData">
<input name="sum_dpct" type="text" class="BigInput" id="sum_dpct" style="width: 120px;" onKeyUp="value=value.replace(/[^0-9^.]/g,'');" onkeypress="check_input()" onblur="check_value(this)"  value="" size="40" />&nbsp;只能填写数字 </td>
    </tr>
	<tr>
      <td nowrap class="TableContent"> 月折旧额：<? get_helps()?></td>
      <td class="TableData">
<input name="mon_dpct" type="text" class="BigInput" id="mon_dpct" style="width: 120px;" onKeyUp="value=value.replace(/[^0-9^.]/g,'');" value="" size="40" readonly /> <input type="button" name="MON_DPCT_CAL"  class="SmallButton" onclick="cal_mon_dpct()" value="计算">
</td>
    </tr>
	<tr>
      <td nowrap class="TableContent"> 启用日期：<? get_helps()?></td>
      <td class="TableData">
<input name="startdate" type="text" class="BigInput" id="startdate" onClick="WdatePicker();" style="width: 200px;" value="" size="40" /> </td>
    </tr>
	...
	<tr>
      ...
      <td class="TableData">
<?php
	  get_pubuser(2,"user","","+选择保管人员",50,4)
	  ?><br> 指定该资产的保管人员      </td>
    </tr>
	</table>	
	...
	<tr>
	  ...
	  <script>
        KE.show({
				...
				<textarea name="content" rows="5" cols="60" style="width:600px;height:300px;"></textarea>
         </td>
    </tr>
