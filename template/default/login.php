...
<input type="hidden" name="dosubmit" value="yes" />
	    <ul class="vipMailbox">
	        <li class="mailname" style="margin-top:100px;">
			<!--<label class="placeholder" for="vipname">输入用户名</label>-->
			<input type="text" value="<?php echo $_COOKIE["username"]?>" name="username" id="vipname" tabindex="1"><a class="clearname" href="#" style="display: none;"></a></li>
			<input type="hidden" value="" name="hidden" class="username focus"> 
	        <li class="mailpass" style="margin-top:5px;"><input type="password" value="" name="password" class="password" id="vippassword" tabindex="2" onkeydown="javascript:if(event.keyCode==13){login.submit();}"/>
			<!--<label class="placeholder" for="vippassword">输入密码</label></li>-->
           <li class="btn">
            <a class="loginBtn" href="javascript:login.submit();" tabindex="3">登录</a></li>
	    </ul>
		</form>
	</div>
	<!--/登录框-->
	<!--尾部-->
		<div class="vipfooter">
			...
			<div class="footenter">
				<div class="copyRight">CopyRight © 2014&nbsp; <a href=" ">四川省扶贫和移民工作局</a></div>
