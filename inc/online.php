...
<div class="bqc_bg" style="margin-bottom: 0px;">
<div class="bqc_on"><span>在线用户</span></div>


<div class="l"><img src="../template/default/images/bqc_or.gif" height="29" width="5" /></div>
<div class="clear"></div>
</div>
<div style="padding: 15px 25px 8px 5px; height:29px;" id="bar1">
