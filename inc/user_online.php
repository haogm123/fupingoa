...
<p class="mt5"><a href="javascript:;" onClick="show_userback('sms_online','<?php echo $row['name']?>','<?php echo $row['phone']?>')" class="sl zoom"  >发短消息</a><span class="dotvline">┊</span>
<a href="../admin.php?ac=add&fileurl=sms">内部邮件</a></p>
</div>
</div>
</li>
