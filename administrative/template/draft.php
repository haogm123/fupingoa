...
<li class="ui-tab-trigger-item<?php echo $_check['ischeck']?>">
<a href="admin.php?ac=<?php echo $ac?>&do=draft&fileurl=<?php echo $fileurl?>&type=<?php echo $_GET['type']?>" class="ui-tab-trigger-text" style="color:#FF0000">我的草稿箱</a></li>					
</ul>
				</div>
 
				<div class="ui-tab-container" id="myScene">
					<div class="ui-tab-container-item ui-tab-container-item-current">
						<table id="tradeRecordsIn dex" class="ui-table">
...
<td class="title">
<a href="admin.php?ac=<?php echo $ac?>&fileurl=<?php echo $fileurl?>&do=draft&id=<?php echo $row['id']?>&type=<?php echo $_GET['type']?>"><?php echo $row['subject']?></a>
</td>
<td class="info"><?php echo $row['date']?></td>
<td class="info"><?php echo get_realname($_USER->id)?></td>
<td class="action">
<a href="admin.php?ac=<?php echo $ac?>&fileurl=<?php echo $fileurl?>&do=draft&id=<?php echo $row['id']?>&type=<?php echo $_GET['type']?>">编辑</a>
|
<a href="admin.php?ac=<?php echo $ac?>&fileurl=<?php echo $fileurl?>&do=draft_delect&id=<?php echo $row['id']?>&type=<?php echo $_GET['type']?>">删除</a>
