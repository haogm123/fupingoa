...
<div id="content" class="ui-content fn-clear" coor="default" coor-rate="0.02">
	<div class="ui-grid-21" coor="content">
		<div class="ui-grid-21 ui-grid-right record-tit" coor="title">
			<h2 class="ui-tit-page"><?php echo $_news['title']?>信息列表</h2>
			
			<div class="record-tit-amount">
				<p>总共有<span class="number"><?php echo public_number('news')?></span>条数据
              </p>
			</div>
		</div>
...
<a href="admin.php?ac=<?php echo $ac?>&fileurl=<?php echo $fileurl?>&type=<?php echo $_GET['type']?>" class="ui-tab-trigger-text" style="color:#FF0000" >信息列表</a>
<li class="ui-tab-trigger-item<?php echo $_check['ischeck']?>">
<a href="admin.php?ac=<?php echo $ac?>&do=draft&fileurl=<?php echo $fileurl?>&type=<?php echo $_GET['type']?>" class="ui-tab-trigger-text">我的草稿箱</a></li>
</li>						
</ul>
				</div>
...
<div class="fn-right">
<?php echo get_exceldown('excel_41')?></div>
</div>
