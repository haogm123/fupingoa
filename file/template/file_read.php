...
<li class="ui-tab-trigger-item<?php if($_GET[type]=='3'){?>  ui-tab-trigger-item-current<?php }?>">
<a href="admin.php?ac=file_read&fileurl=file&type=3" class="ui-tab-trigger-text">已借档案</a></li>
<li class="ui-tab-trigger-item<?php if($_GET[type]=='4'){?>  ui-tab-trigger-item-current<?php }?>">
