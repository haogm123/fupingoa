...
<a href="admin.php?ac=<?php echo $ac?>&fileurl=<?php echo $fileurl?>" class="ui-tab-trigger-text">档案管理</a></li>
...
<?php get_urlkey("编辑","admin.php?ac=edit&do=edit&fileurl=file&id=".$row['id']."","".$row['uid']!=$_USER->id)?></td>						
</tr>
<?}?>			
