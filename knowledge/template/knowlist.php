...
<div id="content" class="ui-content fn-clear" coor="default" coor-rate="0.02">
	<div class="ui-grid-21" coor="content">
		<div class="ui-grid-21 ui-grid-right record-tit" coor="title">
			<h2 class="ui-tit-page">知识信息列表</h2>
			
			<div class="record-tit-amount">
				<p>总共有<span class="number"><?php echo public_number('knowledge')?></span>条数据
              </p>
			</div>
		</div>
...
<div class="fn-right">
<?php echo get_exceldown('excel_39')?></div>
</div>
...
<td class="status"><span class="amount-pay amount-pay-out"><?php echo $row['number']?></span>次</td>
