...
<a href="admin.php?ac=<?php echo $ac?>&fileurl=<?php echo $fileurl?>" class="ui-tab-trigger-text">图书管理</a></li>
<li class="ui-tab-trigger-item">
<a href="admin.php?ac=indexsearch&fileurl=book" class="ui-tab-trigger-text">图书借阅</a></li>	
<li class="ui-tab-trigger-item">
<a href="admin.php?ac=file_read_key&fileurl=book" class="ui-tab-trigger-text">借阅审批</a></li>					
</ul>
				</div>
...
<div class="fn-right">
<?php echo get_exceldown('excel_24')?></div>
</div>
...
<?php get_urlkey("编辑","admin.php?ac=edit&do=edit&fileurl=book&id=".$row['id']."","".$row['uid']!=$_USER->id)?></td>						
</tr>
<?}?>			
