...
<table width="90%" border="0" align="center" cellpadding="3" cellspacing="0" class="small">
  <tr>
    <td class="Big"><img src="template/default/content/images/notify_new.gif" align="absmiddle"><span class="big3"> 图书信息发布</span>&nbsp;&nbsp;&nbsp;&nbsp;
...
<table class="TableBlock" border="0" width="90%" align="center" style="border-bottom:#4686c6 solid 0px;">
    ...
    <tr>
      ...
      <td class="TableData">
<input name="bookumber" type="text" class="BigInput" id="bookumber" style="width: 200px;" maxlength="100" value="<?php echo get_date('YmdHis',PHP_TIME)?>" />      </td>
    </tr>
	<tr>
      <td nowrap class="TableData"> 图书名称：<? get_helps()?></td>
      <td class="TableData">
<input name="bookname" type="text" class="BigInput" id="bookname" style="width: 300px;" maxlength="100" />      </td>
    </tr>
	<tr>
      <td nowrap class="TableData"> 作者：<? get_helps()?></td>
      <td class="TableData">
<input name="author" type="text" class="BigInput" id="author" style="width: 100px;" maxlength="100" /></td>
    </tr>
	<tr>
      <td nowrap class="TableData"> 出版社：</td>
      <td class="TableData">
<input name="publishing" type="text" class="BigInput" id="publishing" style="width: 300px;"  maxlength="100" />      </td>
    </tr>
	<tr>
      <td nowrap class="TableData"> 存放地点：<? get_helps()?></td>
      <td class="TableData">
<input name="appendix" type="text" class="BigInput" id="appendix" size="40" style="width: 350px;" />      </td>
    </tr>
	<tr>
      <td nowrap class="TableData"> 图书数量：<? get_helps()?></td>
      <td class="TableData">
<input name="booknum" type="text" class="BigInput" id="booknum" style="width: 80px;" onKeyUp="value=value.replace(/[^0-9]/g,'');" value="1" size="40" /> 
填写数字，该图书的数里  </td>
    </tr>
