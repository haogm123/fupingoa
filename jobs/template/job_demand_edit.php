...
<table width="90%" border="0" align="center" cellpadding="3" cellspacing="0" class="small">
  <tr>
    <td class="Big"><img src="template/default/content/images/notify_new.gif" align="absmiddle"><span class="big3"> 编辑招聘需求</span>&nbsp;&nbsp;&nbsp;&nbsp;
...
function sendForm()
{
   if(CheckForm())
	...
	<form name="save" method="post" action="?ac=job_demand_edit&do=save&fileurl=jobs" >
...
<table class="TableBlock" border="0" width="90%" align="center" style="border-bottom:#4686c6 solid 0px;">
 <tr>
      ...
      <td class="TableData">
      <input type="text" name="jobpost" class="BigInput" style="width:268px;" value="<?php echo $blog['jobpost']?>" /></td>
    </tr>
      ...
      <td class="TableData">
      <input type="text" name="persondate" class="BigInput" style="width:168px;" size="20" value="<?php echo $blog['persondate']?>" onClick="WdatePicker();" /></td>
    </tr>
	<tr>
