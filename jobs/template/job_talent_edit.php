...
<table width="90%" border="0" align="center" cellpadding="3" cellspacing="0" class="small">
  <tr>
    <td class="Big"><img src="template/default/content/images/notify_new.gif" align="absmiddle"><span class="big3"> 编辑人才</span>&nbsp;&nbsp;&nbsp;&nbsp;
...
<form name="save" method="post" action="?ac=job_talent_edit&do=save&fileurl=jobs" >
...
<table class="TableBlock" border="0" width="90%" align="center" style="border-bottom:#4686c6 solid 0px;">
 <tr>
	  ...
	  <?php
	  get_pubuser(1,"name",$blog['name'],"+选择",70,20)
	  ?>
	  </td>
    </tr>
	<tr>
      ...
      <td class="TableData">
      <input name="sex" type="radio" value="男" <?php if($blog['sex']=='男'){?>checked<?php }?> style="border:0;" />男
			<input name="sex" type="radio" style="border:0;" value="女" <?php if($blog['sex']=='女'){?>checked<?php }?> />
			女	</td>
    </tr>
    ...
    <tr>
      ...
      <td class="TableData">
      <input type="text" name="contact" value="<?php echo $blog['contact']?>" class="BigInput" size="30"></td>
    </tr>
...
<select class="BigStatic" name="job">
	...
	<tr>
      ...
      <td class="TableData"><select name="education" class="BigStatic">
			...
			<?php echo get_typelist($blog['education'],10)?>
			</select>
      </td>
    </tr>
	<tr>
