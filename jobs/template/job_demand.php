...
<div id="content" class="ui-content fn-clear" coor="default" coor-rate="0.02">
	<div class="ui-grid-21" coor="content">
		<div class="ui-grid-21 ui-grid-right record-tit" coor="title">
			<h2 class="ui-tit-page">招聘需求信息列表</h2>
			
			<div class="record-tit-amount">
				<p>总共有<span class="number"><?php echo public_number('job_demand')?></span>条数据
              </p>
			</div>
		</div>
			...
			<div id="J-advanced-filter-option" class="">
				<div class="record-search-time fn-clear">
					<div class="ui-form-item ui-form-item-time">
						...
						<div class="ui-form-content">
							<input type="text" value="<?php echo urldecode($jobpost)?>" name="jobpost" class="ui-input search-keyword" style="width:80px;">
						</div>
						
						<label class="ui-form-label" for="J-start">用人周期：</label>
						<div class="ui-form-content">
		...
		<div class="ui-grid-21 ui-grid-right fn-clear" coor="total">
		                                <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                          <tr>
                                            ...
                                            <td width="9%" align="right" style="padding-right:10px;"><input type="button" value="新增需求" class="BigButtonBHover" onClick="javascript:window.location='admin.php?ac=job_demand_add&fileurl=jobs'"></td>
                                          </tr>
                                        </table>
...
<div class="fn-left"><?php echo get_usershow('-1','admin.php?ac='.$ac.'&fileurl='.$fileurl.'&ischeck='.$ischeck.'&vstartdate='.$vstartdate.'&venddate='.$venddate.'&jobpost='.$jobpost.'&number='.$number.'')?></div>
<div class="fn-right">
<?php echo get_exceldown('excel_26')?></div>
</div>
						...
						<table id="tradeRecordsIndex" class="ui-table">
							...
							<thead>
								<tr>
									...
									<th class="info">需求编号</th>
									<th class="title">招聘岗位</th>
									<th class="info">用人日期</th>
									<th class="info">招聘人数</th>
...
<td class="title">
<a href="admin.php?ac=job_demand_views&fileurl=jobs&id=<?php echo $row['id']?>"><?php echo $row['jobpost']?></a>
</td>
<td class="info"><?php echo $row['persondate']?></td>
<td class="info"><?php echo $row['jobnum']?></td>
<td class="info"><?php echo get_realname($row['uid'])?></td>
<td class="info"><?php echo $row['date']?></td>
<td class="action">
<?php get_urlkey("编辑","admin.php?ac=job_demand_edit&fileurl=jobs&do=edit&id=".$row['id']."","".$row['uid']!=$_USER->id)?>
</td>
