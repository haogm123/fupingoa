...
<table width="90%" border="0" align="center" cellpadding="3" cellspacing="0" class="small">
  <tr>
    <td class="Big"><img src="template/default/content/images/notify_new.gif" align="absmiddle"><span class="big3"> 新增招聘计划</span>&nbsp;&nbsp;&nbsp;&nbsp;
...
<form name="save" method="post" action="?ac=add&do=save&fileurl=jobs">
...
<table class="TableBlock" border="0" width="90%" align="center" style="border-bottom:#4686c6 solid 0px;">
	...
	<tr>
      ...
      <td class="TableData">
      <input type="text" name="number" class="BigInput" size="20" value="<?php echo get_date('YmdHis',PHP_TIME)?>" /></td>
    </tr>
	<tr>
      <td nowrap class="TableContent" width="15%"> 计划名称：<? get_helps()?></td>
      <td class="TableData">
      <input type="text" name="jobpost" class="BigInput" style="width:268px;" size="20" value="" /></td>
    </tr>
	<tr>
      ...
      <select name="channel" class="BigStatic">
			...
			<?php echo get_typelist(0,16)?>
			</select>   还没有渠道? <a href="admin.php?ac=type&fileurl=office&otype=16&muid=133&numberid=145">点击添加渠道>> </a></td>
    </tr>
		<tr>
      <td nowrap class="TableContent" width="15%"> 招聘费用：</td>
      <td class="TableData">
      <input type="text" name="price" class="BigInput" size="15" value=""  onKeyUp="value=value.replace(/[^0-9^.]/g,'');"/> RMB</td>
    </tr>
	
	<tr>
      <td nowrap class="TableContent" width="15%"> 开始日期：<? get_helps()?></td>
      <td class="TableData">
      <input type="text" name="startdate" class="BigInput" style="width:168px;" size="20" value="" onClick="WdatePicker();" /></td>
    </tr>
	<tr>
      <td nowrap class="TableContent" width="15%"> 结束日期：<? get_helps()?></td>
      <td class="TableData">
      <input type="text" name="enddate" class="BigInput" size="20" style="width:168px;" value="" onClick="WdatePicker();" /></td>
    </tr>
	...
	<tr>
     ...
     <tr>
      ...
      <td class="TableData">
	  <?php
	  get_pubuser(2,"examination","","+选择审批人员",50,4)
	  ?>
	  </td>
    </tr>
	<tr>
