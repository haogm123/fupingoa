...
<form name="save" method="post" action="?ac=job_hire_add&do=save&fileurl=jobs">
...
<table class="TableBlock" border="0" width="90%" align="center" style="border-bottom:#4686c6 solid 0px;">
 <tr>
      ...
      <select name="job_talent" class="BigStatic">
			...
			<?php echo get_talent_option(0)?>
			</select>    还没有人才? <a href="admin.php?ac=job_talent_add&fileurl=jobs">点击添加人才>> </a></td>
    </tr>
	  ...
	  <?php
	  get_pubuser(2,"user","","+选择录用负责人",50,4)
	  ?>
	  </td>
    </tr>
	<tr>
      ...
      <td class="TableData">
	  <?php
	  get_depabox(1,"department","","+选择部门",120,20)
	  ?>
	  </td>
    </tr>
    ...
    <tr>
      ...
      <td class="TableData">
      <input type="text" name="hiredate" class="BigInput" style="width:168px;" size="20" value="" onClick="WdatePicker();" /></td>
    </tr>
...
<select class="BigStatic" name="job">
 ...
 <input type="text" name="content" class="BigInput" size="60" value="" />
      </td>
    </tr>
