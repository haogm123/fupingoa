...
<div id="content" class="ui-content fn-clear" coor="default" coor-rate="0.02">
	<div class="ui-grid-21" coor="content">
		<div class="ui-grid-21 ui-grid-right record-tit" coor="title">
			<h2 class="ui-tit-page">印鉴信息列表</h2>
			
			<div class="record-tit-amount">
				<p>总共有<span class="number"><?php echo public_number('seal')?></span>条数据
              </p>
			</div>
		</div>
		...
		<div class="ui-grid-21 ui-grid-right fn-clear" coor="total">
		                                <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                          <tr>
                                            ...
                                            <td width="24%" align="right" style="padding-right:10px;"><input type="button" value="制作印鉴" class="BigButtonBHover" onClick="javascript:window.location='ntko/seal/index.php?uname=<?php echo get_realname($_USER->id)?>&cname=<?php echo $_CONFIG->config_data('name')?>'">&nbsp;&nbsp;<input type="button" value="上传印鉴" class="BigButtonBHover" onClick="javascript:window.location='admin.php?ac=<?php echo $ac?>&fileurl=<?php echo $fileurl?>&do=add'"></td>
                                          </tr>
                                        </table>
...
<li class="ui-tab-trigger-item"></li>	
</ul>
				</div>
...
<td class="title">
<?php echo $row['sealtitle']?>
</td>
<td class="info"><?php echo $row['date']?></td>
<td class="action" ><a href="admin.php?ac=<?php echo $ac?>&fileurl=<?php echo $fileurl?>&do=add&id=<?php echo $row['id']?>">编辑</a></td>
