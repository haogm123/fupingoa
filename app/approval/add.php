...
<form name="save" method="post" action="?ac=<?php echo $ac?>&do=add&fileurl=<?php echo $fileurl?>&apptype=<?php echo $apptype?>">
	...
	<tr>
      <td align="right"> 发文日期：<input style="width:172px;" class="inputdate" type="text" value="<?php echo get_date('Y-m-d',PHP_TIME)?>" name="issuedate" onClick="WdatePicker();" />&nbsp; &nbsp;办结时间：<input style="width:172px;" class="inputdate" type="text" value="" name="end_time" onClick="WdatePicker();" /></td>
    </tr>
	</table>
	...
	<TR>
	  ...
	  <table width="750" border="2" align="center" cellspacing="0" bordercolor="#FF0000" STYLE="font-size:14px;" class="STYLE18">
        <tr>
		  ...
		  <td height="49" bordercolor="#FF0000" bgcolor="#FFFFFF" ><input name="jjcd" type="text" class="inputDocStyle " /></td>
          <td height="49" bordercolor="#FF0000" bgcolor="#FFFFFF" >密级</td>
		  <td height="49" bordercolor="#FF0000" bgcolor="#FFFFFF" ><input name="secrecy" type="text" class="inputDocStyle " /></td>
		  <td height="49" bordercolor="#FF0000" bgcolor="#FFFFFF" >发文字号</td>
		 <td height="49" bordercolor="#FF0000" bgcolor="#FFFFFF" ><input name="fontsize" type="text" class="inputDocStyle " /></td>
        </tr>
        ...
        <tr>
          ...
          <td width="174" bordercolor="#FF0000" bgcolor="#FFFFFF"><input name="sponsor" type="text" class="inputDocStyle " /></td>
          ...
          <td width="225" bordercolor="#FF0000" bgcolor="#FFFFFF" ><input name="gwnum" type="text" class="inputDocStyle " /></td>
        </tr>
        <tr align="center">
        ...
        <tr>
          <td colspan="6" bordercolor="#FF0000" bgcolor="#FFFFFF">文件标题：    
              <input class="inputDocStyle" type="text" name="title" value="" />
          </td>
        </tr>
        <tr>
          <td height="65" colspan="6" bordercolor="#FF0000" bgcolor="#FFFFFF">主送机关：
              <input class="inputDocStyle" type="text" name="delivers" />
          </td>
        </tr>
        <tr>
          <td height="57" colspan="6" bordercolor="#FF0000" bgcolor="#FFFFFF">抄送机关：
              <input class="inputDocStyle" type="text" name="sending" />
          </td>
        </tr>
		<!-- 屏蔽主题词
        <tr>
        ...
        <tr>
          <td height="40" colspan="6" bordercolor="#FF0000" bgcolor="#FFFFFF"><table width="775" border="0" cellspacing="0">
            <tr>
              ...
              <td width="173"><input name="proofread" type="text" class="inputDocStyle " /></td>
              <td width="59">缮印人</td>
              <td width="173">
              ...
              <td width="50">用印人</td>
              <td width="168"><input name="sealing" type="text" class="inputDocStyle " /></td>
            </tr>
          </table></td>
        </tr>
      </table>	  
...
<script language="javascript">
	...
	var t=document.save.annexurlid.value;
	var l=t.indexOf(fl)-9;//alert("文件名起始位置："+l);
	var e=t.indexOf("</a>",l)+5;//alert("结束位置："+e);
	var n=e-l;//alert("长度："+n);
	var s=t.substr(l,n);
	var j=document.save.annexurlid.value;
	document.save.annexurlid.value=j.replace(s,"");
	OM_update_fl();
	}
	function OM_update_fl(){
	var fl=document.save.annexurlid.value;
	if(fl==""){div_filelist.innerHTML="";return false;}
	if(fl.indexOf("【<a href=")==-1){
		//alert("找不到分隔"+fl);
		document.save.annexurlid.value="【<a href="+fl+">未命名文件</a>】";
		fl=document.save.annexurlid.value;
	}
