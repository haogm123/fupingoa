...
<table width="40%" border="0" align="center" cellpadding="3" cellspacing="0" class="small">
  <tr>
    <td class="Big" style="font-size:12px;"><img src="template/default/content/images/notify_new.gif" align="absmiddle"><span class="big3"> 公文收文拟办</span>
    </td>
  </tr>
</table>
...
<?foreach ($result as $row) {?>
	<tr>
      ...
      <td align="center" class="TableData"><a href="admin.php?ac=<?php echo $ac?>&do=add&fileurl=<?php echo $fileurl?>&apptype=<?php echo $row['id']?>">新建收文拟办</a>&nbsp&nbsp&nbsp
