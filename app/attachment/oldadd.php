...
<form name="save" method="post" action="?ac=<?php echo $ac?>&do=add&fileurl=<?php echo $fileurl?>&apptype=<?php echo $apptype?>">
	...
	<tr>
      <td width="83%" align="right"> 来文日期：</td>
      <td width="17%" align="right"><input style="width:172px;" class="inputdate" type="text" value="<?php echo get_date('Y-m-d H:i:sa',PHP_TIME)?>" name="receiptdate" onClick="WdatePicker();" /></td>
    </tr>
	</table>
...
.lefttopbottom {
	...
	<TR HEIGHT=30 ALIGN=center>
		...
		<TD CLASS=ReceiveTd WIDTH=200><input class="inputDocStyle" type="text" name="number" value="<?php echo $result['number']?>" /></TD>
		<TD CLASS=ReceiveTd WIDTH=60>份数</TD>
		<TD CLASS=ReceiveTd WIDTH=100><input class="inputDocStyle" onKeyUp="value=value.replace(/[^0-9^]/g,'');" type="text" name="shares" value="<?php echo $result['shares']?>" /></TD>
...
<option value='1'>急件</option></select>
	...
	<TR HEIGHT=30 ALIGN=center>
		...
		<TABLE WIDTH=100% BORDER=0 CELLSPACING=0 CELLPADDING=0 HEIGHT=100%>
								<TR>
								  <TD width="300"><input class="inputDocStyle" type="text" name="organ" value="<?php echo $result['organ']?>" /></TD>
		...
		<TABLE WIDTH=100% BORDER=0 CELLSPACING=0 CELLPADDING=0 HEIGHT=100%>
								<TR>
								  <TD width="200"><input class="inputDocStyle" type="text" name="fontsize" value="<?php echo $result['fontsize']?>" /></TD>
	...
	<TR HEIGHT=30 ALIGN=center>
		...
		<TD CLASS=ReceiveTd COLSPAN=5><input class="inputDocStyle" type="text" name="title" value="<?php echo $result['title']?>" /></TD>
	</TR>
	<TR HEIGHT=100>
