...
<form name="save" method="post" action="#">
   ...
   <tr>
      ...
      <td class="TableData" >
	  <?php echo get_human_db($blog['id'],"toa_2_LICENSE_TYPE")?>
      </td> 
    </tr>
    <tr>
    	 <td nowrap class="TableContent">证照编号：</td>
      <td class="TableData">
        <?php echo get_human_db($blog['id'],"toa_2_LICENSE_NO")?>
      </td>
    	<td nowrap class="TableContent">证照名称：</td>
      <td class="TableData">
       <?php echo get_human_db($blog['id'],"toa_2_LICENSE_NAME")?>
      </td>
    </tr>
    <tr>
      <td nowrap class="TableContent">取证日期：</td>
      <td class="TableData">
	  <?php echo get_human_db($blog['id'],"toa_2_GET_LICENSE_DATE")?>
     
      </td>
      <td nowrap class="TableContent">生效日期：</td>
      <td class="TableData">
	   <?php echo get_human_db($blog['id'],"toa_2_EFFECTIVE_DATE")?>
    ...
    <tr>
      ...
      <td class="TableData">
	  <?php echo get_human_db($blog['id'],"toa_2_STATUS")?>
      
      </td>
      <td nowrap class="TableContent">到期日期：</td>
      <td class="TableData">
	  <?php echo get_human_db($blog['id'],"toa_2_EXPIRATION_PERIOD")?>
   ...
   <tr>
      ...
      <td class="TableData" colspan=3>
        <?php echo get_human_db($blog['id'],"toa_2_NOTIFIED_BODY")?>
      </td>
    </tr>
    <tr>
      <td nowrap class="TableContent">备注：</td>
      <td class="TableData" colspan=3>
        <?php echo get_human_db($blog['id'],"toa_2_REMARK")?>
      </td>
    </tr> 
