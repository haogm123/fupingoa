...
<table class="TableBlock" width="80%" align="center">
   <tr>
      <td nowrap class="TableContent">关怀类型：</td>
      <td class="TableData" >
        <?php echo get_human_select('toa_10_CARE_TYPE',get_human_form_value('toa_10_CARE_TYPE',10,'inputvaluenum'),get_human_db($blog['id'],"toa_10_CARE_TYPE"))?>
      </td>
      <td nowrap class="TableContent">关怀开支费用：</td>
      <td class="TableData">
        <INPUT type="text"name="toa_10_CARE_FEES" class=BigInput size="12" value="<?php echo get_human_db($blog['id'],"toa_10_CARE_FEES")?>">(元)&nbsp;
      </td>    
    </tr>
    <tr>
      <td nowrap class="TableContent">被关怀员工：</td>
      <td class="TableData">
       <? if($blog['id']==''){?>
        <?php
	 ...
	 <? }?>
      ...
      <td nowrap class="TableContent"> 关怀日期：</td>
      <td class="TableData">
        <?php echo get_human_date('toa_10_CARE_DATE',get_human_db($blog['id'],"toa_10_CARE_DATE"))?>
      </td>
    </tr>
    ...
    <tr>
      ...
      <td class="TableData" colspan=3>
        <textarea name="toa_10_CARE_EFFECTS" cols="60" rows="3" class="BigInput" wrap="on"><?php echo get_human_db($blog['id'],"toa_10_CARE_EFFECTS")?></textarea>
      </td>
    </tr>      
    <tr>
    ...
    <tr>
      ...
      <td class="TableData" colspan=3>
        <textarea name="toa_10_CARE_CONTENT" cols="70" rows="8" class="BigInput" value=""><?php echo get_human_db($blog['id'],"toa_10_CARE_CONTENT")?></textarea>
      </td>
    </tr>
