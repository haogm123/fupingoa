...
<td class="info"><?php echo get_human_db($row['id'],"toa_8_REAPPOINTMENT_TYPE")?></td>
<td class="info"><?php echo get_human_db($row['id'],"toa_8_APPLICATION_DATE")?></td>
<td class="info"><?php echo get_human_db($row['id'],"toa_8_NOW_POSITION")?></td>
<td class="info"><?php echo get_human_db($row['id'],"toa_8_REAPPOINTMENT_DEPT")?></td>
