...
<table class="TableBlock" width="80%" align="center">
   <tr>
	 ...
	 <? }?>
      ...
      <td class="TableData">
        <INPUT type="text"name="toa_5_ABILITY_NAME" class=BigInput size="15" value="<?php echo get_human_db($blog['id'],"toa_5_ABILITY_NAME")?>">
      </td>
    </tr>
    <tr>
    	 <td nowrap class="TableContent">特种作业：</td>
      <td class="TableData">
       <?php echo get_human_radio('toa_5_SPECIAL_WORK',get_human_form_value('toa_5_SPECIAL_WORK',5,'inputvaluenum'),get_human_db($blog['id'],"toa_5_SPECIAL_WORK"))?> 
      </td>
    	<td nowrap class="TableContent">级别：</td>
      <td class="TableData">
       <INPUT type="text"name="toa_5_SKILLS_LEVEL" class=BigInput size="15" value="<?php echo get_human_db($blog['id'],"toa_5_SKILLS_LEVEL")?>">
      </td>
    </tr>
    <tr>
      <td nowrap class="TableContent">技能证：</td>
      <td class="TableData">
        <?php echo get_human_radio('toa_5_SKILLS_CERTIFICATE',get_human_form_value('toa_5_SKILLS_CERTIFICATE',5,'inputvaluenum'),get_human_db($blog['id'],"toa_5_SKILLS_CERTIFICATE"))?> 
      </td>
      <td nowrap class="TableContent">发证日期：</td>
      <td class="TableData">
       <?php echo get_human_date('toa_5_ISSUE_DATE',get_human_db($blog['id'],"toa_5_ISSUE_DATE"))?>
      </td>
    </tr>
    <tr>
      <td nowrap class="TableContent">有效期：</td>
      <td class="TableData">
        <INPUT type="text"name="toa_5_EXPIRES" class=BigInput size="15" value="<?php echo get_human_db($blog['id'],"toa_5_EXPIRES")?>">&nbsp;年      </td>
      <td nowrap class="TableContent">到期日期：</td>
      <td class="TableData">
       <?php echo get_human_date('toa_5_EXPIRE_DATE',get_human_db($blog['id'],"toa_5_EXPIRE_DATE"))?>
      </td>
    </tr>
    <tr>
      <td nowrap class="TableContent">发证机关/单位：</td>
      <td class="TableData" colspan=3>
        <textarea name="toa_5_ISSUING_AUTHORITY" cols="78" rows="3" class="BigInput" value=""><?php echo get_human_db($blog['id'],"toa_5_ISSUING_AUTHORITY")?></textarea>
      </td>
    </tr>
    <tr>
      <td nowrap class="TableContent">备注：</td>
      <td class="TableData" colspan=3>
        <textarea name="toa_5_REMARK" cols="78" rows="3" class="BigInput" value=""><?php echo get_human_db($blog['id'],"toa_5_REMARK")?></textarea>
      </td>
    </tr> 
