						...
						<table id="tradeRecordsIndex" class="ui-table">
							...
							<thead>
								<tr>
									...
									<th class="title">被关怀员工</th>
									<th class="info">关怀类型</th>
									<th class="info">关怀开支费用</th>
									<th class="info">关怀日期</th>
...
<td class="info"><?php echo get_human_db($row['id'],"toa_10_CARE_TYPE")?></td>
<td class="info"><?php echo get_human_db($row['id'],"toa_10_CARE_FEES")?></td>
<td class="info"><?php echo get_human_db($row['id'],"toa_10_CARE_DATE")?></td>
