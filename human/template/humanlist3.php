						...
						<table id="tradeRecordsIndex" class="ui-table">
							...
							<thead>
								<tr>
									...
									<th class="info">所学专业</th>
									<th class="info">所获学历</th>
									<th class="info">所在院校</th>
									<th class="info">证明人</th>
...
<td class="info"><?php echo get_human_db($row['id'],"toa_3_MAJOR")?></td>
<td class="info"><?php echo get_human_db($row['id'],"toa_3_ACADEMY_DEGREE")?></td>
<td class="info"><?php echo get_human_db($row['id'],"toa_3_SCHOOL")?></td>
<td class="info"><?php echo get_human_db($row['id'],"toa_3_WITNESS")?></td>
