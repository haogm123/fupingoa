...
<form name="save" method="post" action="?ac=humanadd&do=addsave&fileurl=<?php echo $fileurl?>&type=<?php echo $type?>">
   ...
   <tr>
	 ...
	 <? }?>
      ...
      <td class="TableData">
        <INPUT type="text"name="toa_6_MEMBER" class=BigInput size="15" value="<?php echo get_human_db($blog['id'],"toa_6_MEMBER")?>">
      </td>
    </tr>
    <tr>
    	<td nowrap class="TableContent"> 与本人关系：</td>
      <td class="TableData" >
        <?php echo get_human_select('toa_6_ELATIONSHIP',get_human_form_value('toa_6_ELATIONSHIP',6,'inputvaluenum'),get_human_db($blog['id'],"toa_6_ELATIONSHIP"))?>
      </td> 
    	<td nowrap class="TableContent">出生日期：</td>
      <td class="TableData">
        <?php echo get_human_date('toa_6_BIRTHDAY',get_human_db($blog['id'],"toa_6_BIRTHDAY"))?>
      </td>
    </tr>
    <tr>
     <td nowrap class="TableContent"> 政治面貌：</td>
      <td class="TableData" >
        <?php echo get_human_select('toa_6_POLITICS',get_human_form_value('toa_6_POLITICS',6,'inputvaluenum'),get_human_db($blog['id'],"toa_6_POLITICS"))?>
      </td>
      <td nowrap class="TableContent"> 职业：</td>
      <td class="TableData">
        <INPUT type="text"name="toa_6_JOB_OCCUPATION" class=BigInput size="15" value="<?php echo get_human_db($blog['id'],"toa_6_JOB_OCCUPATION")?>">
      </td>
    </tr>
    <tr>
      <td nowrap class="TableContent"> 担任职务：</td>
      <td class="TableData">
        <INPUT type="text"name="toa_6_POST_OF_JOB" class=BigInput size="15" value="<?php echo get_human_db($blog['id'],"toa_6_POST_OF_JOB")?>">
      </td>
      <td nowrap class="TableContent"> 联系电话（个人）：</td>
      <td class="TableData">
        <INPUT type="text"name="toa_6_PERSONAL_TEL" class=BigInput size="15" value="<?php echo get_human_db($blog['id'],"toa_6_PERSONAL_TEL")?>">
      </td>
    </tr>
    <tr>
      <td nowrap class="TableContent"> 联系电话（家庭）：</td>
      <td class="TableData">
        <INPUT type="text"name="toa_6_HOME_TEL" class=BigInput size="15" value="<?php echo get_human_db($blog['id'],"toa_6_HOME_TEL")?>">
      </td>
      <td nowrap class="TableContent"> 联系电话（单位）：</td>
      <td class="TableData">
        <INPUT type="text"name="toa_6_OFFICE_TEL" class=BigInput size="15" value="<?php echo get_human_db($blog['id'],"toa_6_OFFICE_TEL")?>">
      </td>
    </tr>
     <tr>
       <td nowrap class="TableContent">工作单位：</td>
      <td class="TableData" colspan=3>
        <textarea name="toa_6_WORK_UNIT" cols="78" rows="2" class="BigInput" value=""><?php echo get_human_db($blog['id'],"toa_6_WORK_UNIT")?></textarea>
      </td>
    </tr>
     <tr>
       <td nowrap class="TableContent">单位地址：</td>
      <td class="TableData" colspan=3>
        <textarea name="toa_6_UNIT_ADDRESS" cols="78" rows="2" class="BigInput" value=""><?php echo get_human_db($blog['id'],"toa_6_UNIT_ADDRESS")?></textarea>
      </td>
    </tr>
    <tr>
       <td nowrap class="TableContent">家庭住址：</td>
      <td class="TableData" colspan=3>
        <textarea name="toa_6_HOME_ADDRESS" cols="78" rows="2" class="BigInput" value=""><?php echo get_human_db($blog['id'],"toa_6_HOME_ADDRESS")?></textarea>
      </td>
    </tr>
   <tr>
      <td nowrap class="TableContent">备注：</td>
      <td class="TableData" colspan=3>
        <textarea name="toa_6_REMARK" cols="78" rows="2" class="BigInput" value=""><?php echo get_human_db($blog['id'],"toa_6_REMARK")?></textarea>
      </td>
    </tr> 
