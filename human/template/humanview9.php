...
<table class="TableBlock" width="80%" align="center">
   <tr>
      ...
      <td class="TableData">
	  <?php echo get_human_db($blog['id'],"toa_9_APPROVE_PERSON_NAME")?>
    ...
    <tr>
      ...
      <td class="TableData">
        <?php echo get_human_db($blog['id'],"toa_9_POST_NAME")?>
      </td>
      <td nowrap class="TableContent"> 获取方式：</td>
      <td class="TableData" >
	  <?php echo get_human_db($blog['id'],"toa_9_GET_METHOD")?>
      </td> 
    </tr>
    <tr>
      <td nowrap class="TableContent"> 申报时间：</td>
      <td class="TableData">
	  <?php echo get_human_db($blog['id'],"toa_9_REPORT_TIME")?>
      
      </td>
      <td nowrap class="TableContent"> 获取时间：</td>
      <td class="TableData">
	  <?php echo get_human_db($blog['id'],"toa_9_RECEIVE_TIME")?>
     ...
     <tr>
      ...
      <td class="TableData">
        <?php echo get_human_db($blog['id'],"toa_9_APPROVE_NEXT")?>
      </td>
      <td nowrap class="TableContent">下次申报时间：</td>
      <td class="TableData">
	  <?php echo get_human_db($blog['id'],"toa_9_APPROVE_NEXT_TIME")?>
    ...
    <tr>
      ...
      <td class="TableData">
	  <?php echo get_human_db($blog['id'],"toa_9_EMPLOY_POST")?>
      
      </td>
      <td nowrap class="TableContent"> 聘用单位：</td>
      <td class="TableData">
       <?php echo get_human_db($blog['id'],"toa_9_EMPLOY_COMPANY")?>
      </td> 
    </tr>
    <tr>
       <td nowrap class="TableContent"> 聘用开始时间：</td>
      <td class="TableData">
	  <?php echo get_human_db($blog['id'],"toa_9_START_DATE")?>
      </td>
      <td nowrap class="TableContent">聘用结束时间：</td>
      <td class="TableData">
	  <?php echo get_human_db($blog['id'],"toa_9_END_DATE")?>
      </td>
    </tr>
	...
	<tr>
      ...
      <td class="TableData" colspan=3>
        <?php echo get_human_db($blog['id'],"toa_9_REMARK")?>
      </td>
    </tr>
