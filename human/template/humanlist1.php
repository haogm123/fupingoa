...
<td class="title">
<a href="admin.php?ac=humanlist&do=view&fileurl=human&id=<?php echo $row['id']?>&type=<?php echo $type?>"><?php echo get_human_db($row['id'],"toa_1_1")?></a>
</td>
<td width="60"><?php echo get_human_db($row['id'],"toa_1_3")?></td>
<td class="info"><?php echo get_human_db($row['id'],"toa_1_30")?></td>
<td class="info"><?php echo get_human_db($row['id'],"toa_1_21")?></td>
