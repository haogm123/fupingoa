...
<body  <?php if($blog['type']!='0'){?>onLoad="toggle('div2');"<?php }?> <?php if($blog['inputtype']=='3' || $blog['inputtype']=='4' || $blog['inputtype']=='5'){ ?> onLoad="toggle2('div1');"<?php }?>>
<table width="90%" border="0" align="center" cellpadding="3" cellspacing="0" class="small">
  <tr>
	...
	<a href="admin.php?ac=human_form&fileurl=<?php echo $fileurl?>&type1=<?php echo $_GET['type1']?>" style="font-size:12px;">返回列表页</a><img src="template/default/content/images/f_ico.png" align="absmiddle"></span>
    </td>
  </tr>
</table>
