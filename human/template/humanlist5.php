						...
						<table id="tradeRecordsIndex" class="ui-table">
							...
							<thead>
								<tr>
									...
									<th class="info">技能名称</th>
									<th class="info">级别</th>
									<th class="info">发证日期</th>
									<th class="info">有效期</th>
...
<td class="info"><?php echo get_human_db($row['id'],"toa_5_ABILITY_NAME")?></td>
<td class="info"><?php echo get_human_db($row['id'],"toa_5_SKILLS_LEVEL")?></td>
<td class="info"><?php echo get_human_db($row['id'],"toa_5_ISSUE_DATE")?></td>
<td class="info"><?php echo get_human_db($row['id'],"toa_5_EXPIRES")?></td>
