...
<table class="TableBlock" width="80%" align="center">
   <tr>
	 ...
	 <? }?>
      ...
      <td class="TableData" >
        <?php echo get_human_select('toa_8_REAPPOINTMENT_TYPE',get_human_form_value('toa_8_REAPPOINTMENT_TYPE',8,'inputvaluenum'),get_human_db($blog['id'],"toa_8_REAPPOINTMENT_TYPE"))?>
      </td> 
    </tr>
    <tr>
    	 <td nowrap class="TableContent">申请日期：</td>
      <td class="TableData">
       <?php echo get_human_date('toa_8_APPLICATION_DATE',get_human_db($blog['id'],"toa_8_APPLICATION_DATE"))?>
      </td>
    	<td nowrap class="TableContent">担任职务：</td>
      <td class="TableData">
        <INPUT type="text"name="toa_8_NOW_POSITION" class=BigInput size="15" value="<?php echo get_human_db($blog['id'],"toa_8_NOW_POSITION")?>">
      </td>
    </tr>
    <tr>
      <td nowrap class="TableContent"> 拟复职日期：</td>
      <td class="TableData">
        <?php echo get_human_date('toa_8_REAPPOINTMENT_TIME_PLAN',get_human_db($blog['id'],"toa_8_REAPPOINTMENT_TIME_PLAN"))?>
      </td>
      <td nowrap class="TableContent"> 实际复职日期：</td>
      <td class="TableData">
        <?php echo get_human_date('toa_8_REAPPOINTMENT_TIME_FACT',get_human_db($blog['id'],"toa_8_REAPPOINTMENT_TIME_FACT"))?>
      </td>
    </tr>    
    <tr>
      <td nowrap class="TableContent">工资恢复日期：</td>
      <td class="TableData">
        <?php echo get_human_date('toa_8_FIRST_SALARY_TIME',get_human_db($blog['id'],"toa_8_FIRST_SALARY_TIME"))?>
      </td>
      <td nowrap class="TableContent">复职部门：</td>
      <td class="TableData" colspan=3>
    	 <?php echo get_depabox(1,'toa_8_REAPPOINTMENT_DEPT',get_human_db($blog['id'],"toa_8_REAPPOINTMENT_DEPT"),"+选择",100,20)?>     	
      </td>
    </tr>
    <tr>
      <td nowrap class="TableContent">复职手续办理：</td>
      <td class="TableData" colspan=3>
        <textarea name="toa_8_MATERIALS_CONDITION" cols="70" rows="3" class="BigInput" value=""><?php echo get_human_db($blog['id'],"toa_8_MATERIALS_CONDITION")?></textarea>
      </td>
    </tr>
	<tr>
      <td nowrap class="TableContent">备注：</td>
      <td class="TableData" colspan=3>
        <textarea name="toa_8_REMARK" cols="70" rows="3" class="BigInput" value=""><?php echo get_human_db($blog['id'],"toa_8_REMARK")?></textarea>
      </td>
    </tr>
   <tr>
      <td nowrap class="TableContent">复职说明：</td>
      <td class="TableData" colspan=3>
        <textarea name="toa_8_REAPPOINTMENT_STATE" cols="70" rows="3" class="BigInput" value=""><?php echo get_human_db($blog['id'],"toa_8_REAPPOINTMENT_STATE")?></textarea>
      </td>
    </tr> 
