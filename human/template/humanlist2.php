						...
						<table id="tradeRecordsIndex" class="ui-table">
							...
							<thead>
								<tr>
									...
									<th class="info">证照类型</th>
									<th class="info">证照编号</th>
									<th class="info">证照名称</th>
									<th class="info">状态</th>
...
<td class="info"><?php echo get_human_db($row['id'],"toa_2_LICENSE_TYPE")?></td>
<td class="info"><?php echo get_human_db($row['id'],"toa_2_LICENSE_NO")?></td>
<td class="info"><?php echo get_human_db($row['id'],"toa_2_LICENSE_NAME")?></td>
<td class="info"><?php echo get_human_db($row['id'],"toa_2_STATUS")?></td>
