...
<table class="TableBlock" width="80%" align="center">
   <tr>
      ...
      <td class="TableData" >
	  <?php echo get_human_db($blog['id'],"toa_10_CARE_TYPE")?>
     
      </td>
      <td nowrap class="TableContent">关怀开支费用：</td>
      <td class="TableData">
        <?php echo get_human_db($blog['id'],"toa_10_CARE_FEES")?>(元)&nbsp;
      </td>    
    </tr>
    <tr>
      ...
      <td class="TableData">
	  <?php echo get_human_db($blog['id'],"toa_10_CARE_DATE")?>
    ...
    <tr>
      ...
      <td class="TableData" colspan=3>
        <?php echo get_human_db($blog['id'],"toa_10_CARE_EFFECTS")?>
      </td>
    </tr>      
    <tr>
      <td nowrap class="TableContent">参与人：</td>
      <td class="TableData" colspan=3>
	  <?php echo get_human_db($blog['id'],"toa_10_PARTICIPANTS")?>
      </td>
    </tr>    
    ...
    <tr>
      ...
      <td class="TableData" colspan=3>
        <?php echo get_human_db($blog['id'],"toa_10_CARE_CONTENT")?>
      </td>
    </tr>
