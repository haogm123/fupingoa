						...
						<table id="tradeRecordsIndex" class="ui-table">
							...
							<thead>
								<tr>
									...
									<th class="title">评定对象</th>
									<th class="info">批准人</th>
									<th class="info">获取职称</th>
									<th class="info">获取方式</th>
									<th class="info">获取时间</th>
...
<td class="info"><?php echo get_human_db($row['id'],"toa_9_APPROVE_PERSON_NAME")?></td>
<td class="info"><?php echo get_human_db($row['id'],"toa_9_POST_NAME")?></td>
<td class="info"><?php echo get_human_db($row['id'],"toa_9_GET_METHOD")?></td>
<td class="info"><?php echo get_human_db($row['id'],"toa_9_RECEIVE_TIME")?></td>
