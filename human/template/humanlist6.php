						...
						<table id="tradeRecordsIndex" class="ui-table">
							...
							<thead>
								<tr>
									...
									<th class="info">成员姓名</th>
									<th class="info">与本人关系</th>
									<th class="info">职业</th>
...
<td class="info"><?php echo get_human_db($row['id'],"toa_6_MEMBER")?></td>
<td class="info"><?php echo get_human_db($row['id'],"toa_6_ELATIONSHIP")?></td>
<td class="info"><?php echo get_human_db($row['id'],"toa_6_JOB_OCCUPATION")?></td>
<td class="info"><?php echo get_human_db($row['id'],"toa_6_POST_OF_JOB")?></td>
