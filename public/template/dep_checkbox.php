...
<body>
  ...
  <div class="demo">
    <div style="margin-bottom:5px; margin-left:10px;">
		<img src="template/default/content/images/notify_new.gif" align="absmiddle"><span class="big3"> 部门信息选择</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        function load() {        
            ...
            $("#showchecked").click(function(e){
				...
				jQuery.ajax({
					  ...
					  window.opener.document.save.<?php echo $_GET[inputname]?>id.value=s.join(",");
					  window.close();
					  }
				   });
