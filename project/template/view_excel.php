...
$html.="<table x:str border=0 cellpadding=0 cellspacing=0 width=612 style='border-collapse:
 ...
 <tr height=33 style='mso-height-source:userset;height:24.95pt'>
  ...
  height:24.95pt'><span style='mso-spacerun:yes'>&nbsp;</span>表单数据内容</td>
	...
	global $db;
	$query = $db->query("SELECT a.*,b.inputtype,b.fromname FROM ".DB_TABLEPRE."project_db a,".DB_TABLEPRE."project_from b where a.projectid='".$row['id']."' and a.fromid=b.fromid and b.inputtype!='6' and (a.type=1 or a.type=4) ORDER BY a.did Asc");
