...
<form name="save" method="post" action="?ac=<?php echo $ac?>&do=add&fileurl=<?php echo $fileurl?>&typeid=<?php echo $typeid?>&projectid=<?php echo $projectid?>&modid=<?php echo $modid?>" style="margin-top:1px; margin-left:0px; margin-right:0px;">
...
//处理多输入表单
global $db;
$num = $db->result("SELECT * FROM ".DB_TABLEPRE."project_from where typeid='".$typeid."' and formtype='2' and tplid='".$modid."' and inputtype=6 ORDER BY fromid Asc");
