...
function show_number()
{
   ...
   window.open("admin.php?ac=<?php echo $ac?>&do=view&fileurl=<?php echo $fileurl?>&lid=<?php echo $row['lid']?>&modid=<?php echo $modid;?>&projectid=<?php echo $projectid;?>&typeid=<?php echo $typeid;?>","","height=600,width=1002,status=0,toolbar=no,menubar=no,location=no,scrollbars=yes,top="+mytop+",left="+myleft+",resizable=yes");
}
</script>
...
<table width="70%" border="0" align="center" cellpadding="3" cellspacing="0" class="small">
  <tr>
	...
	<a href="admin.php?ac=<?php echo $ac?>&fileurl=<?php echo $fileurl?>&type=1&modid=<?php echo $modid;?>&projectid=<?php echo $projectid;?>&typeid=<?php echo $typeid;?>" style="font-size:12px;"><< 返回审批列表</a>&nbsp;|&nbsp;<a href="#" onClick="window.open('admin.php?ac=<?php echo $ac?>&fileurl=<?php echo $fileurl?>&do=flow&lid=<?php echo $row['lid']?>&test=<?php echo $filenumber?>&modid=<?php echo $modid;?>&projectid=<?php echo $projectid;?>&typeid=<?php echo $typeid;?>', 'newwindow', 'height=550, width=500, top=6, right=0, toolbar=no, menubar=no, scrollbars=yes, resizable=no,location=no, status=no')">
...
function sendForm()
{
   if(CheckForm())
	...
	<form name="save" method="post" action="admin.php?ac=<?php echo $ac?>&do=personnel&fileurl=<?php echo $fileurl?>&modid=<?php echo $modid;?>&projectid=<?php echo $projectid;?>&typeid=<?php echo $typeid;?>">
