...
<table x:str border=0 cellpadding=0 cellspacing=0 width=1262 style='border-collapse:
 ...
 <tr height=80 style='mso-height-source:userset;height:60.0pt'>
  ...
  width:948pt'><?php echo P_I_DB($typeid,$modid,'_4_11_2_date',100,25)?>工程制作进度</td>
 </tr>
 ...
 <tr height=33 style='mso-height-source:userset;height:24.95pt'>
  ...
  width:47pt'><?php echo $i+1;?></td>
  <td class=xl26 width=133 style='border-top:none;border-left:none;width:100pt'><?php echo P_I_DB($typeid,$modid,'_4_11_2_a1',120,25)?></td>
  <td class=xl26 width=209 style='border-top:none;border-left:none;width:157pt'><?php echo P_I_DB($typeid,$modid,'_4_11_2_a2',190,25)?></td>
  <td class=xl26 width=98 style='border-top:none;border-left:none;width:74pt'><?php echo P_I_DB($typeid,$modid,'_4_11_2_a3',90,25)?></td>
  <td class=xl26 width=139 style='border-top:none;border-left:none;width:104pt'><?php echo P_I_DB($typeid,$modid,'_4_11_2_a4',130,25)?></td>
  <td class=xl26 width=167 style='border-top:none;border-left:none;width:125pt'><?php echo P_I_DB($typeid,$modid,'_4_11_2_a5',160,25)?></td>
  <td class=xl26 width=85 style='border-top:none;border-left:none;width:64pt'><?php echo P_I_DB($typeid,$modid,'_4_11_2_a6',78,25)?></td>
  <td class=xl26 width=186 style='border-top:none;border-left:none;width:140pt'><?php echo P_I_DB($typeid,$modid,'_4_11_2_a7',180,25)?></td>
  <td class=xl26 width=182 style='border-top:none;border-left:none;width:137pt'><?php echo P_I_DB($typeid,$modid,'_4_11_2_a8',170,25)?></td>
 </tr>
<?php }?>
 <tr height=33 style='mso-height-source:userset;height:24.95pt'>
  <td colspan=4 height=33 class=xl27 width=503 style='height:24.95pt;
  width:378pt'>填报人：<?php echo get_realname($_USER->id)?></td>
